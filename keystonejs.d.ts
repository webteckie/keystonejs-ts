...
declare module "keystone" {
	...
	export interface IList extends mongoose.Document {
		 ...
		 * @param callback the function to call after done processing
		 */
		updateItem(item: IList, data: Object, options: any, callback: (err: ErrorCallback) => void): void;
	}
	...
	export interface IKeystone {
		 ...
		 */
		pre(routes: string, middleware: () => void): void
